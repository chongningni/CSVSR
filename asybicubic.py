...
for dataset_name in test_datasets:
    for scale in scales:
        ...
        rslt_path = os.path.join(path, "results", dataset_name, 'bicubic', "x" + str(scale))
        ...
        val_dataset  = VSR_AsyTestDataset(dir=test_path, scale = scale, model_name = 'bicubic')
        ...
        for batch, sample in tqdm(enumerate(dataloader), total=len(val_dataset)):
            input_batch, label_batch, output_batch, name, scale, elapsed_time = sample['lr'], sample['hr'], sample['hr_bicubic'], sample['im_name'], sample['scale'], sample['elapsed_time']
            input_batch, label_batch, output_batch = (Variable(input_batch.cuda()), Variable(label_batch.cuda()), Variable(output_batch.cuda()))
            # print(elapsed_time)
